            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-5">
                ...
                <div className="d-flex flex-column justify-content-start">
                  <NavLink className="text-white mb-2" to="/">
                    <i className="fa fa-angle-right mr-2"></i>Home
                  </NavLink>
                  <NavLink className="text-white mb-2" to="about">
                    <i className="fa fa-angle-right mr-2"></i>About Us
                  </NavLink>
                  <NavLink className="text-white mb-2" to="service">
                    <i className="fa fa-angle-right mr-2"></i>Our Services
                  </NavLink>
                  <NavLink className="text-white mb-2" to="price">
